package com.nanda.googlemapanimation.helpers;
...
public class GoogleMapRipple {
  ...
  private volatile double distance = 2000;
  ...
  public GoogleMapRipple(GoogleMap googleMap, LatLng latLng, Context context) {
    this.googleMap = googleMap;
    this.latLng = latLng;
    this.prevlatlng = latLng;
    drawable = (GradientDrawable) ContextCompat.getDrawable(context, R.drawable.bg_ripple);
  ...
  public void withNumberOfRipples(int numberOfRipples) {
    if (numberOfRipples > 4 || numberOfRipples < 1) numberOfRipples = 4;
  ...
  final Runnable runnable1 = new Runnable() {
    @Override public void run() {
      gOverlays[0] = googleMap.addGroundOverlay(
          new GroundOverlayOptions().position(latLng, (int) distance)
